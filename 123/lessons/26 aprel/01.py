        ...
        for line in f:
            ...
            for letter in line:
                ...
                if letter == "к" or letter == "К":
                    count_k += 1
    print(f'В {file} "e" встречается {count_e} раз')
    print(f'В {file} файле буква "а" встречается {count_a} раз')
    print(f'В {file} "к" встречается {count_k} раз \n')
